...
def add_hotkeys():
    ...
    keyboard.add_hotkey("Ctrl+Alt+.", obsidian_colleagues_and_alumni.update_colleagues_and_alumni_for_all_files)
    keyboard.add_hotkey("Alt+.", obsidian_colleagues_and_alumni.update_colleagues_and_alumni_for_single_file)
